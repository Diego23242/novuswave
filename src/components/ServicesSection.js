  ...
  const services = [
    {
      ...
      icon: (
        <svg className="w-12 h-12 text-[#1FB8D2]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div 
              key={index} 
              className="bg-white p-8 rounded-lg shadow-sm hover:shadow-lg transition-all transform hover:-translate-y-2"
            >
              <div className="mb-6">
                {service.icon}
              </div>
